...
public class PlayerController : MonoBehaviour
{
    ...
    {
        _numTouches++;
      //  _gameManager.TeamTouch();
        _touched?.Invoke(this);
    }
    ...
    public void SetCommand(bool isRight, GameManager gameManager)
    {
        _teamRight = isRight;
